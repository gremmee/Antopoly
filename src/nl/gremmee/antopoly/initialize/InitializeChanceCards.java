...
public class InitializeChanceCards {
    ...
    public ChanceCardList initializeChanceCards(final TileList aTileList) {
        if (this.chanceCardList == null) {
            ...
            this.chanceCardList.addRandom(new PayCard("Speeding", "Boete voor te snel rijden ƒ 15", 15));
            this.chanceCardList.addRandom(new PayCard("Schoolfee", "Betaal schoolgeld ƒ 150", 150));
            ...
            this.chanceCardList.addRandom(new PayCard("Bank pays", "De bank betaalt u ƒ 50 dividend", 50));
            this.chanceCardList.addRandom(
            ...
            this.chanceCardList.addRandom(
                    new ReceiveCard("Buildinginsurance", "Uw bouwverzekering vervalt, u ontvangt ƒ 150", 150));
            this.chanceCardList.addRandom(new PayCard("Drunk", "Aangehouden wegens dronkenschap ƒ 20 boete", 20));
            ...
            this.chanceCardList.addRandom(
                    new ReceiveCard("Crossword puzzle", "U hebt een kruiswoordpuzzel gewonnen en ontvangt ƒ 100", 100));
